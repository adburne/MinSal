<?php
class SubregionData {
	public static $tablename = "subregiones";
	...
	public function getRegion(){ return RegionData::getById($this->codregion);}


    public function add(){
		$sql = "insert into ".self::$tablename." (nombre,codregion) ";
		$sql .= "value (\"$this->nombre\",\"$this->codregion\")";
		Executor::doit($sql);
	}
