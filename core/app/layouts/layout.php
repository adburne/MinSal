...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Ministerio de Salud | Dashboard</title>
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="./" class="logo">
          ...
          <span class="logo-lg">Ministerio de <b>Salud</b></span>
        </a>
...
<div class="user-panel">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="./?view=subregiones">Subregiones</a></li>
                <li><a href="./?view=regiones">Regiones</a></li>
              </ul>
            </li>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="./?view=privileges">Privilegios</a></li>
                <li><a href="./?view=userprivileges">Privilegios por usuario</a></li>
    ...
    <?php endif;?>
      ...
      <div class="content">
        ...
        <strong>Copyright &copy; 2018 <a href="./?view=home" target="_blank">Ministerio de Salud</a></strong>
      </footer>
      <?php else:?>
<div class="login-box">
      <div class="login-logo">
        <a href="./">Ministerio de <b>Salud</b></a>
      </div><!-- /.login-logo -->
