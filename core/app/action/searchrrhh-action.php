...
<br><table class="table table-bordered table-hover">
	...
	<tr>
		...
		<td style="width:70px;">
		<a href="index.php?view=editRRHH&id=<?php echo $RRHH->id; ?>" class="btn btn-xs btn-warning"><i class="glyphicon glyphicon-pencil"></i></a>
		<a href="index.php?view=delRRHH&id=<?php echo $RRHH->id; ?>" class="btn btn-xs btn-danger"><i class="fa fa-trash"></i></a>
		</td>
	</tr>
	<?php endforeach;?>
</table>
